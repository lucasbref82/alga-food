...
alter table grupo_permissao add constraint FK_permissao_grupo_permissao foreign key (permissao_id) references permissao (id);
alter table grupo_permissao add constraint FK_grupo_grupo_permissao foreign key (grupo_id) references grupo (id);
